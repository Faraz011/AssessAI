      ...
      <div className="min-h-[calc(100vh-200px)] flex flex-col gap-6 px-8 py-8">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-[#303030]" style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 700, letterSpacing: '-0.8px' }}>
              Assignments
            </h1>
          </div>
          <p className="text-sm text-[rgba(94,94,94,0.55)]" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>
        ...
        <div className="bg-white rounded-[20px] overflow-hidden p-4 flex items-center justify-between gap-4 shadow-sm">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5 text-[#a9a9a9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
            </svg>
            <span className="text-sm font-semibold text-[#a9a9a9]" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>Filter By</span>
          </div>
          <div className="border border-[rgba(0,0,0,0.2)] rounded-full px-4 py-2 flex items-center gap-3 flex-1 max-w-sm">
            ...
            <input type="text" placeholder="Search Assignment" className="text-sm text-[#a9a9a9] outline-none flex-1 bg-transparent" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }} />
          </div>
        </div>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <h3
                      ...
                      style={{ fontFamily: "'Bricolage Grotesque', sans-serif", fontWeight: 800, letterSpacing: '-0.96px', lineHeight: 1.2 }}
                    >
                      {a.input?.title || "Untitled"}
                    </h3>
                    <div className="relative ml-2">
                      <button 
                        onClick={() => setOpenMenuId(openMenuId === a.jobId ? null : a.jobId)}
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="text-[rgba(0,0,0,0.5)]" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>
                      <span className="font-extrabold text-[#303030]" style={{ fontWeight: 800 }}>Assigned on</span>
                      <span>: {new Date(a.createdAt).toLocaleDateString('en-GB')}</span>
                    </div>
                    <div className="text-[rgba(0,0,0,0.5)]" style={{ fontFamily: "'Bricolage Grotesque', sans-serif" }}>
                      <span className="font-extrabold text-[#303030]" style={{ fontWeight: 800 }}>Due</span>
                      <span>: {new Date(a.updatedAt).toLocaleDateString('en-GB')}</span>
                    </div>
                  </div>
                </div>
              ))}
